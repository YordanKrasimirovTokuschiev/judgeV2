...
import com.softuni.judgev2.model.binding.ExerciseAddBindingModel;
...
public class ExerciseController {
    ...
    public String addConfirm(@Valid ExerciseAddBindingModel exerciseAddBindingModel,
        ...
        if (bindingResult.hasErrors()) {
            ...
            redirectAttributes.addFlashAttribute("org.framework.validation.BindingResult.exerciseAddBindingModel"
                    , bindingResult);
